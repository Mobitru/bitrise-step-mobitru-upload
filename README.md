...
This Bitrise step is used to upload an APK or IPA file to Mobitru platform.
...
```yml
envs:
- MOBITRU_ACCESS_KEY: <your access key>
- MOBITRU_ADDRESS: <https://your-test-instance.mobitru.com/>
```
